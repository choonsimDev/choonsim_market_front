...
interface SellFirstStepComponentProps {
  data: any;
  setData: (data: any) => void;
  setStep: (step: number) => void;
}

export const SellFirstStepComponent: React.FC<SellFirstStepComponentProps> = ({
  data,
  setData,
  setStep,
}) => {
  ...
  return (
    <Container>
      <StyledImage src="/svg/img/progressbar-sell-01.png" alt="progress-bar" />
      <Title>판매 심부름 요청</Title>
      <Description>
