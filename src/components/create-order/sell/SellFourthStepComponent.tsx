...
interface SellFourthStepComponentProps {
    orderData: any;
}

export const SellFourthStepComponent: React.FC<SellFourthStepComponentProps> = ({
    orderData
}) => {
    ...
    return (
        <Container>
            ...
            <Title><BlueText>현재 상태: 입금확인중</BlueText></Title>
