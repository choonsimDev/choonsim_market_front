...
export const BuyComponent = () => {
    ...
    return(
        <>
            {step === 1 && <BuyFirstStepComponent data={data} setData={setData} setStep={setStep} />}
            {step === 2 && <BuySecondStepComponent data={data} setData={setData} setStep={setStep} setOrderData={setOrderData}/>}
